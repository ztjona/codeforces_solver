...
class Auxiliar:
    ...
    def __init__(self, case):
        ...
        if case == 0:
            self.prints = ['2', '2 2', '100000 20']
            self.resps = [4, 226732710]
        elif case == 1:
            self.prints = ['1', '6', '3 5 1 6 4 2']
            self.resps = [4, ]
...
class Pruebas(unittest.TestCase):
    @patch('andSumBig.print', create=True) # al mockear se debe poner la ruta completa.
    @patch('andSumBig.input', create=True)
